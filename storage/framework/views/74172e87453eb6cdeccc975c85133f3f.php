...
<?php $component->withAttributes([]); ?>
    <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h2 class="text-2xl font-semibold text-slate-800">Edit Item: <?php echo e($itemMaster->code); ?></h2>
        </div>

        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <form action="<?php echo e(route('item-masters.update', $itemMaster->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="location_id" id="location_id" required
                            ...
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($location->id); ?>" <?php echo e(old('location_id', $itemMaster->location_id) == $location->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code" id="code" value="<?php echo e(old('code', $itemMaster->code)); ?>" required
                            class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="serial_no" id="serial_no" value="<?php echo e(old('serial_no', $itemMaster->serial_no)); ?>"
                            class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="qty" id="qty" value="<?php echo e(old('qty', $itemMaster->qty)); ?>" required min="0"
                            class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
                        <?php $__errorArgs = ['qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
                    ...
                    <div class="mb-4">
                        ...
                        <select name="uom" id="uom" required
                            ...
                            <?php $__currentLoopData = $uoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($uom); ?>" <?php echo e(old('uom', $itemMaster->uom) == $uom ? 'selected' : ''); ?>>
                                    <?php echo e($uom); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="serviced_date" id="serviced_date" value="<?php echo e(old('serviced_date', $itemMaster->serviced_date ? \Carbon\Carbon::parse($itemMaster->serviced_date)->format('Y-m-d') : '')); ?>"
                            class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="equipment" id="equipment" rows="3" required
                        class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500"><?php echo e(old('equipment', $itemMaster->equipment)); ?></textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-6">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="status" value="operational" <?php echo e(old('status', $itemMaster->status) == 'operational' ? 'checked' : ''); ?>
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="status" value="non-operational" <?php echo e(old('status', $itemMaster->status) == 'non-operational' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4 <?php echo e(old('status', $itemMaster->status) == 'non-operational' ? '' : 'hidden'); ?>" id="reason-container">
                    ...
                    <textarea name="status_reason" id="status_reason" rows="2"
                        ...
                        class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-rose-500 focus:border-rose-500 bg-rose-50/30 text-slate-800 placeholder-slate-400"><?php echo e(old('status_reason', $itemMaster->status_reason)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded transition-colors">Update Item</button>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/item_masters/edit.blade.php ENDPATH**/ ?>