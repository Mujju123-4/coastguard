...
<?php $component->withAttributes([]); ?>
    <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <form action="<?php echo e(route('item-masters.upload')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/item_masters/import.blade.php ENDPATH**/ ?>