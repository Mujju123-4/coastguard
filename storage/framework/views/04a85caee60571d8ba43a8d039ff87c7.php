...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans antialiased">
        <div class="h-screen bg-slate-50 flex overflow-hidden">
            ...
            <aside class="w-64 bg-slate-900 shadow-xl hidden sm:flex flex-col text-white relative z-20">
                <div class="h-16 flex justify-center items-center px-6 border-b border-white/10">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" class="w-8 h-8 mr-3" alt="ICG Logo">
                    <!--<span class="text-lg font-bold tracking-wider uppercase">ICG Admin</span>-->
                </div>
                <nav class="flex-1 px-4 py-8 space-y-2">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('dashboard') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('users.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('users.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                    ...
                    <!--<a href="<?php echo e(route('roles.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('roles.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">-->
                    ...
                    <!--<a href="<?php echo e(route('permissions.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('permissions.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">-->
                    ...
                    <a href="<?php echo e(route('locations.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('locations.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('notices.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('notices.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view item masters')): ?>
                    <a href="<?php echo e(route('item-masters.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('item-masters.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="<?php echo e(route('user-manuals.index')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('user-manuals.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="<?php echo e(route('contact_details')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('user-manuals.*') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                      Contact details 
                    ...
                    <!--<div class="pt-4"></div>-->
                    <!--<a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-3 <?php echo e(request()->routeIs('profile.edit') ? 'bg-orange-600/20 text-orange-400 border border-orange-500/30' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?> rounded-lg transition-colors">-->
                    <!--    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">-->
                ...
                <header class="h-16 flex-shrink-0 bg-white shadow-sm flex items-center justify-between px-8 z-10 border-b border-slate-200" style="position:relative;">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            <div @click="open = !open" class="flex items-center space-x-3 cursor-pointer hover:bg-slate-50 p-1.5 rounded-xl transition-colors select-none">
                                <div class="text-sm font-medium text-slate-600 hidden sm:block"><?php echo e(Auth::user()->name); ?></div>
                            ...
                            <div x-show="open" 
                                 ...
                                 class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg shadow-slate-200 border border-slate-100 overflow-hidden z-50 py-1"
                                 style="display: none;">
                                 
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 hover:text-orange-600 transition-colors">
                                ...
                                <form method="POST" action="<?php echo e(route('logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="flex items-center w-full px-4 py-2.5 text-sm text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors text-left">
                            ...
                            <div id="tc-contact-wrapper" style="margin-top:12px; padding:12px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:1rem; display:none;">
                                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:10px; border-bottom:1px solid #f1f5f9; padding-bottom:6px;">
                                    <div style="display:flex; align-items:center; gap:0.4rem;">
                                        <svg style="width:0.85rem; height:0.85rem; color:#d97706;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                                        <p style="font-size:0.625rem;font-weight:800;color:#92400e;text-transform:uppercase;letter-spacing:.08em;margin:0;">Focal Contact Point</p>
                                    </div>
                                    <span style="font-size:0.55rem; font-weight:800; background:#f0f9ff; color:#0369a1; border:1px solid #bae6fd; padding:1px 6px; border-radius:4px; text-transform:uppercase;">Developer View</span>
                                </div>
                                <div style="padding-left:4px;">
                                    <div id="tc-contact-name" style="font-size:0.875rem; font-weight:800; color:#0f172a; margin-bottom:4px;"></div>
                                    <div style="display:flex; flex-direction:column; gap:3px;">
                                        <div style="display:flex; align-items:center; gap:0.6rem;">
                                            <svg style="width:0.75rem; height:0.75rem; color:#94a3b8;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                            <span id="tc-contact-email" style="font-size:0.75rem; color:#475569; font-weight:500;"></span>
                                        </div>
                                        <div style="display:flex; align-items:center; gap:0.6rem;">
                                            <svg style="width:0.75rem; height:0.75rem; color:#94a3b8;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                            <span id="tc-contact-phone" style="font-size:0.75rem; color:#475569; font-weight:500;"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    (function () {
        ...
        var POLL_MS      = 20000;
        var CHAT_POLL    = 8000;
        var LS_KEY       = 'notif_last_seen_at_<?php echo e(auth()->id()); ?>';
        var LS_REPLY_KEY = 'notif_last_reply_seen_at_<?php echo e(auth()->id()); ?>';   // non-admin: tracks when user last saw a reply
        var CSRF         = (document.querySelector('meta[name="csrf-token"]') || {getAttribute:function(){return '';}}).getAttribute('content');
        var NOTIF_URL    = '<?php echo e(route("tickets.notifications")); ?>';
        var TICKETS_URL  = '<?php echo e(url("tickets")); ?>';
        var IS_ADMIN     = <?php echo e(auth()->user()->hasAnyRole(['Admin', 'Superadmin', 'Super Admin']) ? 'true' : 'false'); ?>;
        var CAN_SEND_MSG = <?php echo e(auth()->user()->hasAnyRole(['Super Admin', 'Location User', 'Location Users']) ? 'true' : 'false'); ?>;


        // If local variable isn't found, default to user creation date to avoid showing everything ever created
        var defaultTs       = '<?php echo e(auth()->user()->created_at ? auth()->user()->created_at->toISOString() : "1970-01-01T00:00:00Z"); ?>';
        var lastSeenAt      = localStorage.getItem(LS_KEY)       || defaultTs;
...
</html><?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/layouts/app.blade.php ENDPATH**/ ?>