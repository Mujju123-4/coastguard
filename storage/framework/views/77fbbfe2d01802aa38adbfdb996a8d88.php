...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <div>
                <a href="<?php echo e(route('notices.create')); ?>" class="inline-flex items-center px-5 py-2.5 bg-orange-600 border border-transparent rounded-xl font-bold text-white hover:bg-orange-700 active:bg-orange-800 transition-all shadow-lg shadow-orange-600/20">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#notices-table').DataTable({
                ...
                ajax: "<?php echo e(route('notices.index')); ?>",
                columns: columns,
                language: {
                    search: '',
...
<?php endif; ?><?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/notices/index.blade.php ENDPATH**/ ?>