            ...
            <div class="flex flex-col items-center justify-center mb-8 text-center">
                <div class="flex items-center justify-center gap-8 mb-4">
                    <a class="transition-transform hover:scale-105 duration-300">
                        <img src="<?php echo e(asset('images/icg-logo.png')); ?>" alt="Indian Coast Guard Logo"
                            class="h-24 w-auto drop-shadow-2xl">
                    </a>
                    <?php if(request()->routeIs('login')): ?>
                        <div class="h-16 w-px bg-white/20 mx-2"></div>
                        <img src="<?php echo e(asset('images/LAMOR LOGO1.png')); ?>" alt="LAMOR Logo"
...
<?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/layouts/guest.blade.php ENDPATH**/ ?>