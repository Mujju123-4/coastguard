...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h2 class="text-2xl font-semibold text-slate-800">Edit Permission: <?php echo e($permission->name); ?></h2>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            <form action="<?php echo e(route('permissions.update', $permission->id)); ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $permission->name)); ?>" class="mt-1 block w-full border-slate-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500" required>
...
<?php endif; ?>
<?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/permissions/edit.blade.php ENDPATH**/ ?>