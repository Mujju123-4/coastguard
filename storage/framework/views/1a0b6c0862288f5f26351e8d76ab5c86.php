...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
            ...
            <div class="flex flex-wrap items-center gap-3 bg-white p-2 rounded-[22px] border border-slate-100 shadow-xl shadow-slate-200/50">
                <?php if(auth()->user()->hasAnyRole(['Superadmin', 'Super Admin'])): ?>
                ...
                <?php if(auth()->user()->hasAnyRole(['Superadmin', 'Super Admin'])): ?>
                <a href="<?php echo e(route('item-masters.import')); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create item masters')): ?>
                <a href="<?php echo e(route('item-masters.create')); ?>"
                ...
                <table id="item-master-table" class="w-full border-separate border-spacing-y-0.5">
                    <thead>
                        <tr class="bg-slate-50/50">
                            ...
                            <?php if(auth()->user()->hasAnyRole(['Super Admin', 'Location Users'])): ?>
    ...
    $(document).ready(function () {
        ...
        var hasActionRole = <?php echo e(auth()->user()->hasAnyRole(['Super Admin', 'Location Users']) ? 'true' : 'false'); ?>;
        ...
        var table = $('#item-master-table').DataTable({
            ...
            ajax: {
                url : "<?php echo e(route('item-masters.index')); ?>",
    ...
    function exportItemMaster() {
        ...
        var url   = "<?php echo e(route('item-masters.export')); ?>";
    ...
    function resetTicketModal() {
        ...
        document.getElementById('ticket-contact-name').value         = "<?php echo e(auth()->user()->name); ?>";
        document.getElementById('ticket-contact-email').value        = "<?php echo e(auth()->user()->email); ?>";
        document.getElementById('ticket-contact-phone').value        = "<?php echo e(auth()->user()->phone); ?>";
...
<?php endif; ?><?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/item_masters/index.blade.php ENDPATH**/ ?>