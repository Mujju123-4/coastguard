...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('roles.create')); ?>" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded transition-colors">
                Add New Role
            </a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900"><?php echo e($role->name); ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="<?php echo e(route('roles.edit', $role->id)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
...
<?php endif; ?>
<?php /**PATH /home/casanovasheaven/public_html/coastguard/resources/views/roles/index.blade.php ENDPATH**/ ?>