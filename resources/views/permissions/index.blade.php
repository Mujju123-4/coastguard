<x-app-layout>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('permissions.create') }}" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded transition-colors">
                Add New Permission
            </a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">{{ $permission->name }}</td>
