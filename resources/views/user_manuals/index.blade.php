...
>>>>>>> 89a3400d8febfa7c0af4cd0221386851a7d4c933
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            @foreach($manualsForCards as $manual)
                    ...
                    <div class="p-5">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('user-manuals.view', $manual->id) }}" target="_blank" class="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition-all" title="View PDF">
...
>>>>>>> 89a3400d8febfa7c0af4cd0221386851a7d4c933
                        ...
                        <p class="text-xs text-slate-400 mb-4 flex items-center">
                            ...
                            Uploaded on {{ $manual->created_at->format('M d, Y') }}
                        </p>
                        <a href="{{ route('user-manuals.download', $manual->id) }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-slate-800 text-white text-sm font-semibold rounded-lg hover:bg-slate-900 transition-colors">
                            Download Now
                        </a>
                    </div>
                </div>
